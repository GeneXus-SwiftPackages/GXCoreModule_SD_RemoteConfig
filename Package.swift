...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.0.0-beta.2.xcframework.zip",
			checksum: "6c534ec401c50df1826d2982eb1712ac4dffb061d2a66eedd81f0b65ad866dea"
		)
	]
)