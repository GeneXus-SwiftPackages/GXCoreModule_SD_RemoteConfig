...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.6.xcframework.zip",
			checksum: "47161981005fb1ea9cbe803e2f5ca13eeed302adef08a502dc75f24f0f34e54e"
		)
	]
)