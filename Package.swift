...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-4.2.0-rc.0.xcframework.zip",
			checksum: "785b4640b4905f3aa5609998914eae0097450adc0eeab4e872f78277f189fea5"
		)
	]
)