...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.0.6.xcframework.zip",
			checksum: "7492d0ce1be3885d12c28173588eefdee556ca9750cbe256828afdfb12632629"
		)
	]
)