...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.6.0-beta.2.xcframework.zip",
			checksum: "94e182c13249c34b776f60d7284cbf27e579ba9481a8caa80f2d93b8ec885ad1"
		)
	]
)