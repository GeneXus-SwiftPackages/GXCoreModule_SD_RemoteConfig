...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.1.0-beta.3.xcframework.zip",
			checksum: "76b7d692363163aed3dfff4cc0853371ee1baad50ee35e097565b423d549b21d"
		)
	]
)