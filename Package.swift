...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.6.0-beta.4.xcframework.zip",
			checksum: "30209a28dc59685dcbd2161d2e32abe26f1fd0b0badb64ddfad04302849cb5c6"
		)
	]
)