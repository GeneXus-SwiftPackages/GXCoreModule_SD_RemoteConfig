...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.1.2.xcframework.zip",
			checksum: "0a0af6b1bcd2776cf33b165e183ad0f75ccd8fba5e266de79412a17d910d5025"
		)
	]
)