...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-4.2.0-beta.7.xcframework.zip",
			checksum: "4329d2ba3ef510c8c013cacf6d3aa9c1d7b0d879d17c7edc21b412a247aa2183"
		)
	]
)