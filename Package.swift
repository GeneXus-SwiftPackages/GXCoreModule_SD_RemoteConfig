...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-2.1.0.xcframework.zip",
			checksum: "6bc553e97ce24bc09374bc73873ee9ec522fea85659382e9a00cc011d4204429"
		)
	]
)