...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.3.3.xcframework.zip",
			checksum: "b941b6032ff1f4420c34be2f9f2425cfb29da22d318a6f118c7301d45c2b1cf7"
		)
	]
)