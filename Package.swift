...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.1.0-beta.4.xcframework.zip",
			checksum: "903a898ab7cf96f41bfed992802081547d61ba2525c844ea27f8812a4a45d26e"
		)
	]
)