...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.1.3.xcframework.zip",
			checksum: "67a348f62aefb5c3eba6054645e0d36514ad64216eb2792c42776e15c17cdf90"
		)
	]
)