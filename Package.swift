...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.0.5.xcframework.zip",
			checksum: "5b4ff092a118ab3a139adb679ecd9d2ef5d5668b61826071736cc15e8c4ff771"
		)
	]
)