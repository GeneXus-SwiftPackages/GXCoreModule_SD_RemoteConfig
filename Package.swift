...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-2.1.3.xcframework.zip",
			checksum: "da90741dc1516ab2edb76607af9a2cbeaa2bf496e440e07e838011ef16cb3a39"
		)
	]
)