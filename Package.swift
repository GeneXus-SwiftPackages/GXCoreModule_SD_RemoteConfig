...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.5.11.xcframework.zip",
			checksum: "e1514045cd83923b55566a1bf76e70720ffe79c5a078306e648ffebfe78a0ed7"
		)
	]
)