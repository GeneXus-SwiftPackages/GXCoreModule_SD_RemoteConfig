...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.4.0-beta.5.xcframework.zip",
			checksum: "12fa3e4bb07918e75250f8f679889f518972d76b06b3f9afc7b3c1530c0a2ebd"
		)
	]
)