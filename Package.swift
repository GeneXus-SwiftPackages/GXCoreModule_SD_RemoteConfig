...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-2.0.0-beta.6.xcframework.zip",
			checksum: "43ee756dacb3e745d3f0462041bb942b6f385fc30868fd42b9fd7934ac738d35"
		)
	]
)