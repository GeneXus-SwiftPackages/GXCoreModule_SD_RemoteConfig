...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.3.0-beta.9.xcframework.zip",
			checksum: "0a1e71e030c0f3a42a76d9d1d57155feb3956127d41565b9305efb921a054ee6"
		)
	]
)