...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.3.0-beta.1.xcframework.zip",
			checksum: "104a55c6fba21a64461485d3bf66283452c7909e8ace651003c9bb8808396226"
		)
	]
)