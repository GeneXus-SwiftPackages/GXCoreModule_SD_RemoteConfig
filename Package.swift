...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-5.0.0-beta.5.xcframework.zip",
			checksum: "e22f19833bd74253cede34420f996c79129ea7561087b09dd0fb1dabf6e641aa"
		)
	]
)