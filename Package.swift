...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-1.1.0-rc.3.xcframework.zip",
			checksum: "288adb798ccb0ff6ea3d3609a766183050824bfa6ba541f965531ce3c2f5ed55"
		)
	]
)