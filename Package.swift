...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-2.0.18.xcframework.zip",
			checksum: "749db15a4d3693bbffe946234199424658f1b9b726fd1846700136a3e6d93fa2"
		)
	]
)