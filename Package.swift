...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.3.0.xcframework.zip",
			checksum: "8a1ad7526375fd9b1ade27b00151f21c0453971e3ba4dff74aaa4c5bfde1268a"
		)
	]
)