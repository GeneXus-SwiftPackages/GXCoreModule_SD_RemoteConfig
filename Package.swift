...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-1.6.0-rc.0.xcframework.zip",
			checksum: "b5e38999ada791b3a0e1a7d6ba3430de6ae513c87c8c122de1558cf848fb4756"
		)
	]
)