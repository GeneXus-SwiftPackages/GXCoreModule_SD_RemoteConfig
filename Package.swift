...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-4.1.0-beta.6.xcframework.zip",
			checksum: "88aeef68849b71fb6a5e227d485d6d4be116b818cf5e5a852c781b1c030ae34c"
		)
	]
)