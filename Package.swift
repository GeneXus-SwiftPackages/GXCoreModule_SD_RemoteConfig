...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-2.2.0-beta.14.xcframework.zip",
			checksum: "9ba2e1668d36bcd1cd423e5b7a3bccebd7e5cc28784929f16780ca0515dcd02e"
		)
	]
)