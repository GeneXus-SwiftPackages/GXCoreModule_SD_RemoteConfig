...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-4.0.0-rc.43.xcframework.zip",
			checksum: "80d0a82cd32ede8db3a3a37638c9150d7fdb4c549e5b24a1a159bab43bc5a65c"
		)
	]
)