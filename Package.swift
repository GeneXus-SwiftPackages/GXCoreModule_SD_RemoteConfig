...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.8.xcframework.zip",
			checksum: "2ff6df667b42685a5852aaa34de9b55563f7108d68eeb6a945c8c6ccf8f8d122"
		)
	]
)