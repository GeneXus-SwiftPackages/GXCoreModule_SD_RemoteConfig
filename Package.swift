...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.1.0-beta.7.xcframework.zip",
			checksum: "887278b0793314439686fc3c6a914a81e4d02397ce35653da49bd6fc20e3cc99"
		)
	]
)