...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.2.2.xcframework.zip",
			checksum: "d751cad254fb40c2bd316b8a10a1e98351cc00266a269c1881bb01376143c4ea"
		)
	]
)