...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.4.0-beta.2.xcframework.zip",
			checksum: "45c41fa0496b85783d1c3526ed90a58b6b02f1e94452d0f93c7784d5724cfabd"
		)
	]
)