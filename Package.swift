...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.1.0-beta.11.xcframework.zip",
			checksum: "75ce339deb4daf4d7cef3022ab1d1d20266980fef30375a0f2cb1c23fd26e151"
		)
	]
)