...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-4.1.0-beta.15.xcframework.zip",
			checksum: "f2e7fb3c092bc2537a0278fb45c3d1a9f32b490cc00447c5235541c27da0ce10"
		)
	]
)