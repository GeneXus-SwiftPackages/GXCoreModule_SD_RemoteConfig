...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-4.1.0-beta.9.xcframework.zip",
			checksum: "61a88534d2c482c8a55f1175abbf32fdf702a2b8f4eb0592dd01b468aaee0241"
		)
	]
)