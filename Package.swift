...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-3.0.1.xcframework.zip",
			checksum: "e5b9951cb29fc27bdfaa6e5ae593130a09576954aa7825037c0fdeee97b6916d"
		)
	]
)