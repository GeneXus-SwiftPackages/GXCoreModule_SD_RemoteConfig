...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-2.0.0-beta.36.xcframework.zip",
			checksum: "17d885c465b8dcdf35866f6278b26c520dadf36670535c55c335d5cb6add3e27"
		)
	]
)