...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.4.0-beta.6.xcframework.zip",
			checksum: "dedfba202955ccdabd855b049aa39a12984e153ac83d551537ac8a46fea3a4d2"
		)
	]
)