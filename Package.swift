...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.3.0-beta.7.xcframework.zip",
			checksum: "a882c64619162950c811dceb97448979a9ff74ac735742466bb9102918450178"
		)
	]
)