...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.6.0-beta.0.xcframework.zip",
			checksum: "8478f181963f40f4a5a6970c76cc01b16f9434845e14f6c38e5aa69150c2698e"
		)
	]
)