...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.0.8.xcframework.zip",
			checksum: "e2ea214bf393aef09077d8568b9f6e711276589a59fabe67994285d20b08c975"
		)
	]
)