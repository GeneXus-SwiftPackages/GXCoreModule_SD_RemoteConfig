...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.0.0-beta.20230630152236.xcframework.zip",
			checksum: "3b4b1e6bfe24a4b0f6bad375e2e70c3e2795a3a41815a2e914b1d3b53b6881cd"
		)
	]
)