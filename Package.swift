...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.1.1.xcframework.zip",
			checksum: "e127a2fdf5f4f192b0510706e0247a951c529138f414307c15ce9f0461a3e393"
		)
	]
)