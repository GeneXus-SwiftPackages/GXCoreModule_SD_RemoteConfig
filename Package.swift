...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-3.2.0-rc.13.xcframework.zip",
			checksum: "9cb9e32a317bc0e374b585fd27171402295024c3072b82aea721cb590db274b2"
		)
	]
)