...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.7.xcframework.zip",
			checksum: "9337b0c758f60adb8ca2c5c384fb4c2b7c559d0ccab4670a7668593965236448"
		)
	]
)