...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-2.1.4.xcframework.zip",
			checksum: "c3837264a7fe7f8d90a905f6361f629e67aa11f4a8ac8063953e82e3027eea1a"
		)
	]
)