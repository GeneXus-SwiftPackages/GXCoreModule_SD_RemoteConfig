...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.1.0-beta.8.xcframework.zip",
			checksum: "9ca7a558bd5848fdb3d41e3fc5fe919551eba97fa6ebe7f4be71fe6bfdf437b1"
		)
	]
)