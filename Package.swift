...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.0.0-beta.8.xcframework.zip",
			checksum: "6c0b01e076cd6659cfca5149c927e48423bb4d72abd14095cfc0846d07d819c5"
		)
	]
)