...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.1.0-beta.8.xcframework.zip",
			checksum: "a85e50a5df6f3e37c2352a46efb8c789db042f756fe6933f08f9062684b4bf9d"
		)
	]
)