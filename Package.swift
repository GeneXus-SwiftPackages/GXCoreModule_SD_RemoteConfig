...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-2.2.0-beta.8.xcframework.zip",
			checksum: "7d8b3176b7420d5e8ec75c9ae8f625136b937fed871cd772d6ed5840676c6cf0"
		)
	]
)