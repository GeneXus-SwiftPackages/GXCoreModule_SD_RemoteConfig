...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.4.0-beta.8.xcframework.zip",
			checksum: "4cdd03d9785c00b7c9da46e42ddf950eb6fc81cbc151bcafbc859b20c7ddf03c"
		)
	]
)