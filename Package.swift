...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.2.xcframework.zip",
			checksum: "8aae068b55f25d126465c8e164d1c201ce0e93c66694e484d388e1d3a868d676"
		)
	]
)