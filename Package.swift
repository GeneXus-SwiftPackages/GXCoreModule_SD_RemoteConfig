...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.5.17.xcframework.zip",
			checksum: "208f436017863794970e28e131029b40f341a83f1b6ff8fc61c3e1b060bce2a2"
		)
	]
)