...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-4.2.0-rc.37.xcframework.zip",
			checksum: "f31c7e2e0a293d4af022c6976a603e00b2bd5af16fceb422e6cdf7b633419c61"
		)
	]
)