...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.1.0-beta.9.xcframework.zip",
			checksum: "5211d08ead483c5c736171847501c3ddb2c189d3fe421a9e7fac889af6defa81"
		)
	]
)