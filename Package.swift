...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.6.0-beta.3.xcframework.zip",
			checksum: "5f13e810eaae7757301b230adcbe24f448035dc11c6fb4b968bdec7a3641d3e0"
		)
	]
)