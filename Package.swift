...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.4.0-beta.3.xcframework.zip",
			checksum: "9f04d635a747b7d64a7397cfd7751d7c3242d6b39401b8f1c1422bb3e3bb35f3"
		)
	]
)