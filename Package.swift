...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.1.0-beta.9.xcframework.zip",
			checksum: "5da9f3e7e27452c494e9dd461a14a97b42a139a610fcf2baa46e4083506cf721"
		)
	]
)