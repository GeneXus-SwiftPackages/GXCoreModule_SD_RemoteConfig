...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-3.2.0.xcframework.zip",
			checksum: "2dd16ddeaa38a5794ce6ea9104353d29e9c79a92702fe0e7824f5147b4d8786f"
		)
	]
)