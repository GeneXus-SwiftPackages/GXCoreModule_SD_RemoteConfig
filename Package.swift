...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.9.xcframework.zip",
			checksum: "c8dd58c256ea8e4543960c511eabb394f3aa5d7baf9f6ab29674f142860664f3"
		)
	]
)