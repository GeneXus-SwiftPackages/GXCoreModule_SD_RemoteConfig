...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.0.7.xcframework.zip",
			checksum: "0503d4586317cfbb9c4973ffc21265685ca0458c74f3bab78cf94b3f95ddc8b5"
		)
	]
)