...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.0.16.xcframework.zip",
			checksum: "e4db86fb8910292730e95133cc35142d51989287df5ada96a23f99f58ab7e1db"
		)
	]
)