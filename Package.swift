...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.0.0-beta.9.xcframework.zip",
			checksum: "ed2adec9d58f4f3778768136692d3379e43ef4983e2d42112efe322880a17039"
		)
	]
)