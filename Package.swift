...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.4.29.xcframework.zip",
			checksum: "12384202335d3bdcbf3b268e5c5ce900aabb9d68eb662ba35942d49aee16bcc1"
		)
	]
)