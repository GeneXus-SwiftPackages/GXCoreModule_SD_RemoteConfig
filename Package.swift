...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.3.0-beta.5.xcframework.zip",
			checksum: "542a5658422f1af26646a66148dee77beb0b087ae8b068d8ba4f5d2b511653a4"
		)
	]
)