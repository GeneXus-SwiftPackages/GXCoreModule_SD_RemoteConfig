...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.1.5.xcframework.zip",
			checksum: "a31098366773b332ea395d0d829f07d16854046a2423a852556599cd6f494bfc"
		)
	]
)