...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-4.1.0.xcframework.zip",
			checksum: "f55583e1a9e8ecd3fd72735b3675bd9b0288781ad89e8f04498e0e8aa304dec6"
		)
	]
)