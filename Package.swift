...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.1.0-beta.0.xcframework.zip",
			checksum: "5e86d6ef8e64d77378e5952d8f2c7d76bd13ebe9ac98ae1eacba0172a2a91854"
		)
	]
)