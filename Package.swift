...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-4.2.0-beta.2.xcframework.zip",
			checksum: "d942be1a456f02f7cbce62798f2c9d253f0da00bce3da772f4ae0135b018a375"
		)
	]
)