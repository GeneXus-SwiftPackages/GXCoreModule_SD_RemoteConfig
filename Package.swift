...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.3.0-beta.8.xcframework.zip",
			checksum: "ddee72eb9d722857e1e6d6325a309c90eb13308598bc380bc149297d2088c5ed"
		)
	]
)