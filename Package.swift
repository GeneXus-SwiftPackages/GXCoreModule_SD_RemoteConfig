...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.3.0-beta.6.xcframework.zip",
			checksum: "02a46e15f5ae7f4518ace35c18f9c4c27a1bd6a7f7901f5d3b6b1e503f2037f3"
		)
	]
)