...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-3.0.0-rc.15.xcframework.zip",
			checksum: "fd008211bc550c89705adaa4a3e58a57f21e23c9e772fe3aa7444471c4ded88f"
		)
	]
)