...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.2.0-beta.1.xcframework.zip",
			checksum: "f20cdec4abc8a86f13ff199642f0219373c5aa1180d0ed530d658ee3ee860e41"
		)
	]
)