...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.2.0.xcframework.zip",
			checksum: "c6981f7c559f551819bdc42290b331f80ad00830cc534d9e6475eb67d3d8acff"
		)
	]
)