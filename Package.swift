...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.2.0-beta.32.xcframework.zip",
			checksum: "68d1a06ad5aad2051f76b4ee1bcc8c65cbe5d463f41ad50a7d3eb368f4d5bbd1"
		)
	]
)