...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.3.xcframework.zip",
			checksum: "ea51bf7cba526abc5df953258d8e20d141ddbfce1f18bfafc33d6c841a256506"
		)
	]
)