...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-5.0.0-beta.1.xcframework.zip",
			checksum: "ea32015c782c74bdcb8d51bc604f39e4797a1150a90b64a5629ab2f9e36c872b"
		)
	]
)