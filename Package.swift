...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.3.6.xcframework.zip",
			checksum: "357cf0aaee970dfa7b79b73e2817b20d5b16984b734c1ebf9dcdb0a316734ef5"
		)
	]
)