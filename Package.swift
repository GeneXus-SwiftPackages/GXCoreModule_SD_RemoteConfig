...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-3.0.0-beta.4.xcframework.zip",
			checksum: "751b65d4134f95d061bf999de081aac80e065f047c47e216541562e787bc45f7"
		)
	]
)