...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.2.0-beta.26.xcframework.zip",
			checksum: "6fdf41e8d707deeb5be68042e5f6cf76b221cc34fd755b150e2fe40219a345ca"
		)
	]
)