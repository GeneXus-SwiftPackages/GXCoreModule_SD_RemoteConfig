...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.5.xcframework.zip",
			checksum: "bc4bdb28f7beb378c2636a6aa0fa62de7ca000c3165a55acf8edb9def5964973"
		)
	]
)