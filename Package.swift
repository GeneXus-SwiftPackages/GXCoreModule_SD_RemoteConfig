...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-4.2.0-beta.22.xcframework.zip",
			checksum: "2d7055728140c2029f9e4fa4a22f885eaa8aa5d74fc66c6b9a75313ed2beec43"
		)
	]
)