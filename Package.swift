...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-3.1.0.xcframework.zip",
			checksum: "0dc3f3a5a4cd2598f5e9b0461995bdd698ad8f2868c7265123c17f726fe85d3b"
		)
	]
)