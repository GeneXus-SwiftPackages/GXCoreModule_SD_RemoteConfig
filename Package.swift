...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-4.0.0-rc.0.xcframework.zip",
			checksum: "605987d8b5eeddadd8ddc6e9666043751d2cbf95f8a35e5ceb51a6bd42c71412"
		)
	]
)