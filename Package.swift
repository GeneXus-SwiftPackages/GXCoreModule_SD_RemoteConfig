...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_RemoteConfig-1.4.0-rc.21.xcframework.zip",
			checksum: "65213868cd449776743d85f79aef28327bac37eee1adee181513c354cc94eab9"
		)
	]
)