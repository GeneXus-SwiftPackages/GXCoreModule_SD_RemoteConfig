...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-2.2.0-beta.17.xcframework.zip",
			checksum: "f07fb9b5f83526cb3962497dbc38ac196f5d44acb518012d76519da399d0b0dc"
		)
	]
)