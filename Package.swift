...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.2.0-beta.7.xcframework.zip",
			checksum: "14dcd99373aec242c22825a90a836dc27ad56163a8cef2090262bb27cf72d8e8"
		)
	]
)