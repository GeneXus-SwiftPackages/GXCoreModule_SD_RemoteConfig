...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.4.30.xcframework.zip",
			checksum: "a862bd84c05bc775d647d1338e0b6566b0b6b24b498ee787453fa278d23ee723"
		)
	]
)