...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-1.5.0-beta.4.xcframework.zip",
			checksum: "6000efbd30ccf770da9f70864994ac250b407ad9202761f85cbe1018ad887730"
		)
	]
)