...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.1.0-rc.1.xcframework.zip",
			checksum: "0fced8c4c279b9f47d601146d364d699909ba852cce49ca240673312b584b290"
		)
	]
)