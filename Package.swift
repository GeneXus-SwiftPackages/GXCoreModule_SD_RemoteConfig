...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_RemoteConfig-4.2.0-beta.1.xcframework.zip",
			checksum: "66b4f2b17a9493e6bfc13b2b3f8846c24e4a1e076cdeceb14c525bc918673797"
		)
	]
)