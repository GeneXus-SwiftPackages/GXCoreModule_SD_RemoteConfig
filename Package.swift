...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_RemoteConfig",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_RemoteConfig-1.1.2.xcframework.zip",
			checksum: "157314706c15d4fc18fa1ae89f53fa731e7ca0f6b661a270e866978da0ade1d8"
		)
	]
)